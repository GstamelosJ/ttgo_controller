...
BLYNK_WRITE(V0)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH1 ON!");
    delay(100);
    Blynk.virtualWrite(20,(channels[0]?1:0));
...
BLYNK_WRITE(V1)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH1 ON!");
    delay(100);
    Blynk.virtualWrite(21,(channels[1]?1:0));
   // Blynk.virtualWrite(11,255);
    //msg1="The CH2 set on";
   // msg2="for "+ String(pg_hours)+" Hours";
   // LCDwrite(msg1, msg2 );
...
BLYNK_WRITE(V2)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH3 ON!");
    delay(100);
    Blynk.virtualWrite(22,(channels[2]?1:0));
...
BLYNK_WRITE(V3)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH4 ON!");
    delay(100);
    Blynk.virtualWrite(23,(channels[3]?1:0));
...
BLYNK_WRITE(V4)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH5 ON!");
    delay(100);
    Blynk.virtualWrite(24,(channels[4]?1:0));
...
BLYNK_WRITE(V5)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH6 ON!");
    delay(100);
    Blynk.virtualWrite(25,(channels[5]?1:0));
...
BLYNK_WRITE(V6)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH7 ON!");
    delay(100);
    Blynk.virtualWrite(26,(channels[6]?1:0));
...
BLYNK_WRITE(V7)  // Manual selection
{
  ...
  { //turn ON the pgm
    ...
    Blynk.notify("CH8 ON!");
    delay(100);
    Blynk.virtualWrite(27,(channels[7]?1:0));
